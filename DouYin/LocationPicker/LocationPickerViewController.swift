...
open class LocationPickerViewController: UIViewController {
	...
	open override func loadView() {
		...
		if showCurrentLocationButton {
			...
			button.setImage(UIImage(named: "region", in: bundle, compatibleWith: nil), for: UIControlState())
...
extension LocationPickerViewController: MKMapViewDelegate {
	...
	func selectLocationButton() -> UIButton {
        ...
        button.setTitleColor(UIColor(hexString: Constants.ColorScheme.blackColor), for: .normal)
